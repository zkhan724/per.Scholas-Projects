...
public class AllAboutMe {
	...
	public static void main(String[] args) {
		...
		int num1 = Integer.parseInt(height);//converting string to an integer
		int num2 = (int) (num1 * 30.48);//taking the converted integer and doing the centimeter calculation
